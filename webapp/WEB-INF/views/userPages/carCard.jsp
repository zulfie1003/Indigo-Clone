...
<%@ page import="com.example.entity.Car"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
.form-style:hover {
	...
	box-shadow: 0 0 3px cyan, 0 0 9px cyan, 0 0 18px cyan, 0 0 36px cyan, 0
		0 72px cyan;
}
		...
		<div class="card-container">
			<c:choose>
				<c:when test="${not empty existingCard}">
					...
					<form action="/confirmCar/${car.carId }" method="get">
				...
				<c:otherwise>
					...
					<form:form modelAttribute="card" action="/car/payments"
						method="post">
						<input type="hidden" name="carId" value="${param.carId}">
