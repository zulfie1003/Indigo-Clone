		...
		<div class="card-container">
			<c:choose>
				<c:when test="${not empty existingCard}">
					...
					<form action="/confirmBus" method="get">
				...
				<c:otherwise>
					...
					<form:form modelAttribute="card" action="/bus/payments"
						method="post">
						<input type="hidden" name="seats" value="${param.seats}" />
						<input type="hidden" name="bus_id" value="${param.bus_id}">
