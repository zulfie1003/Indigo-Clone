...
<%@ page import="com.example.entity.Bus"%>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
...
<body>
	<section class="form-section">
		<div class="form-container">
			...
			<h1 class="title">
				...
				<span>(ID: <%=selectedBus.getBus_id()%>)
				</span>
			</h1>
			<form action="/bus/payment" method="get"
				onsubmit="validateForm(event)">
				<input type="hidden" name="seats" id="selectedSeats"> <input
					type="hidden" name="bus_id" value="<%=selectedBus.getBus_id()%>">

				<div class="seat-container">
					<c:forEach var="seat" items="${bus.getAvailableSeats()}">
				...
				<p class="seat-info">
					You have selected <span id="seatCount">0</span> seat(s): <span
						id="seatList">None</span>
				</p>
	...
	<script>
		...
		function updateSeatList() {
			...
			document.getElementById('seatList').innerText = seatCount > 0 ? selectedSeats
					.join(', ')
					: 'None';
		}
